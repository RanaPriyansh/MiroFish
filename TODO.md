...
Repository: https://github.com/RanaPriyansh/MiroFish.git
Canonical local path: /root/MiroFish
Default branch: main
...
3. Run the local setup path for MiroFish and write exact commands back into README if they are missing or stale.
